...
class LeftMenu extends React.Component {
  ...
  <div class="col-2 pt-3 leftMenu">
    <div class="nav flex-column " id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link dropdown" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
      ...
      <a class="nav-link" id="v-pills-settings-tabC" data-toggle="pill" href="#v-pills-settingsC" role="tab" aria-controls="v-pills-settingsC" aria-selected="false">
